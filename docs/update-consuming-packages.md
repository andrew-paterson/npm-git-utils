...
const options = = {
  ...
  localConsumingPackages: [
    ...
    },
    {
      ...
      preleaseType: 'dev', // Opional, can be any string. If present, the version will be bumped in the consuming package.json file, but simply appending the string and datetime to the current version. If present, the releaseType option is ignored.
    },
    {
